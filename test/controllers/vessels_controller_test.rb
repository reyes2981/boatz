...
class VesselsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vessel" do
    assert_difference('Vessel.count') do
      post vessels_url, params: { vessel: { berths: @vessel.berths, location: @vessel.location, name: @vessel.name, owner_id: @vessel.owner_id } }
    end
  ...
  test "should update vessel" do
    patch vessel_url(@vessel), params: { vessel: { berths: @vessel.berths, location: @vessel.location, name: @vessel.name, owner_id: @vessel.owner_id } }
